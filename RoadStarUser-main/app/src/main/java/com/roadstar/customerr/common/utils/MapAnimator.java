...
//        }
        ...
        PolylineOptions optionsBackground = new PolylineOptions().add(bangaloreRoute.get(0)).color(Color.parseColor(context.getResources().getString(0+R.color.color_polyline))).width(5);
        backgroundPolyline = googleMap.addPolyline(optionsBackground);

        optionsForeground = new PolylineOptions().add(bangaloreRoute.get(0)).color(Color.parseColor(context.getResources().getString(0+ R.color.color_polyline))).width(5);
