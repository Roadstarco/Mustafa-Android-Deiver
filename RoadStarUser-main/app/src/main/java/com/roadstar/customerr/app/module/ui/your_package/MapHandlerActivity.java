...
public class MapHandlerActivity extends BaseRecyclerViewActivity implements OnMapReadyCallback, LocationListener {
    ...
    private void setMapCurrentLoc( ) {
        ...
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) ==
            ...
            locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, MIN_TIME, MIN_DISTANCE,  MapHandlerActivity.this); //You can also use LocationManager.GPS_PROVIDER and LocationManager.PASSIVE_PROVIDER
