...
public class PhotoPickerDialog extends BottomSheetDialog implements View.OnClickListener {
    ...
    public void onStart() {
        ...
        TextView textViewCamera = dialog.findViewById(com.roadstar.customerr.R.id.tv_photo_lib);
        TextView textViewGallery = dialog.findViewById(com.roadstar.customerr.R.id.tv_take_photo);
        TextView textViewCancel = dialog.findViewById(com.roadstar.customerr.R.id.cancel_dialog_tv);
